...
<html>
    ...
    <div class="row justify-content-center">
        <h1 class="col-lg-4 mb-3 text-danger">Inicio de Sesion</h1>
        <hr>
        <h4 class="col-lg-3 mb-3 text-danger">Ingresa Tus Credenciales</h4>
        <hr>
        <h4 class="col-lg-3 mb-3 text-danger">Perfil Administrador</h4>
    </div>
     ...
     <!-- 2 columnas del layout -->
       ...
       <!-- Boton inicio Sesion -->
            <div class="row col-left">   
                <a href="ModeAdmin2.php" class="btn btn-danger btn-block mb-4">INICIAR SESION</a> 
            </div>
