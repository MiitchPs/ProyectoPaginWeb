<!-- Footer -->
                 <footer class="container-fluid bg-dark text-center text-white">
                   ...
                   <div class="container p-4">
                     ...
                     <section class="mb-4">
                       <!-- Facebook -->
                       <a class="btn btn-outline-light btn-floating m-1" href="https://www.youtube.com/watch?v=dQw4w9WgXcQ" rel="nofollow"
                  ...
                  target="_blank"><i class="fab fa-linkedin-in"></i
                       ...
                       <form action="">
                         ...
                         <div class="row d-flex justify-content-center">
                           ...
                           <div class="form form-dark">
                               ...
                               <label class="form-label text-white" for="formWhite"></label>
                           </div>
                           </div>
                           <!--Grid column-->
                   ...
                   <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
                      © 2021 Copyright:
                     <a class="text-white" href="">MitchelPoblete.com</a>
                   </div>
                   <!-- Copyright -->
                 </footer>
                 <!-- Footer -->